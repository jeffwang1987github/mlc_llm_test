...
set(stdout_log "/home/wangqx/work/mlc_llm_test/build/tvm_ffi/libbacktrace/logs/project_libbacktrace-install.log")
set(stderr_log "/home/wangqx/work/mlc_llm_test/build/tvm_ffi/libbacktrace/logs/project_libbacktrace-install.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/wangqx/work/mlc_llm_test/build/tvm_ffi/libbacktrace/logs/project_libbacktrace-install-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "project_libbacktrace install command succeeded.  See also /home/wangqx/work/mlc_llm_test/build/tvm_ffi/libbacktrace/logs/project_libbacktrace-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
