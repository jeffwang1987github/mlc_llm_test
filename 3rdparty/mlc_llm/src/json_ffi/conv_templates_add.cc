...
Conversation_add ChatML() {
  Conversation_add conv;
  conv.name = "chatml";
...
Conversation_add OpenHermesMistral() {
...
Conversation_add NeuralHermesMistral() {
  // Identical to chatml except for the system prompt and stop tokens
  Conversation_add conv;
...
Conversation_add Qwen3() {
  ...
  // TODO(mlc-team): add eos to mlc-chat-config
  // and remove eos from stop token setting.
  conv.stop_tokens = {151645,151643};
  conv.stop_str = "<|im_end|>";
  conv.add_bos = false;
  return conv;
}

Conversation_add Llama2() {
  Conversation_add conv;
  conv.name = "llama-2";
  conv.system =
...
Conversation_add MistralDefault() {
  Conversation_add conv;
...
Conversation_add CodeLlamaCompletion() {
  Conversation_add conv;
...
Conversation_add CodeLlamaInstruct() {
  Conversation_add conv;
...
Conversation_add RedPajamaChat() {
  Conversation_add conv;
...
Conversation_add StableCodeCompletion() {
  Conversation_add conv;
...
Conversation_add StableCodeInstruct() {
  Conversation_add conv;
...
Conversation_add WizardCoderOrMATH() {
...
Conversation_add GemmaInstruction() {
  Conversation_add conv;
...
using ConvFactory = Conversation_add (*)();

Conversation_add Conversation_add::FromTemplate(const std::string& name) {
