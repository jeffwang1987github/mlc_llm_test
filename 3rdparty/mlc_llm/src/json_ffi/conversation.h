...
class Conversation_add {
 public:
  ...
  Conversation_add() = default;

  inline bool operator==(const Conversation_add& other) const {
    bool eq_roles = true;
   ...
   */
  static Conversation_add FromTemplate(const std::string& name);
