...
void Conversation_add::LoadJSONOverride(const picojson::value& config_json, bool partial_update) {
...
void Conversation_add::LoadJSONOverride(const std::string& config_str, bool partial_update) {
...
picojson::value Conversation_add::SerializeToJSON() const {
...
std::string Conversation_add::GetConfigJSON() const { return SerializeToJSON().serialize(true); }
